...
> ```yaml
>    uses: shaftoe/pi-coding-agent-action@v2.20.3
> ```
...
| `@earendil-works/pi-agent-core` | `0.79.6` | Pi Agent Core — agent orchestration primitives |
| `@earendil-works/pi-ai` | `0.79.6` | Pi AI — AI model abstractions and providers |
| `@earendil-works/pi-coding-agent` | `0.79.6` | Pi SDK — AI coding agent runtime |
...
| `typebox` | `1.2.14` | JSON Schema Type Builder |
