...
| `@earendil-works/pi-agent-core` | `0.79.7` | Pi Agent Core — agent orchestration primitives |
| `@earendil-works/pi-ai` | `0.79.7` | Pi AI — AI model abstractions and providers |
| `@earendil-works/pi-coding-agent` | `0.79.7` | Pi SDK — AI coding agent runtime |
