...
| `@earendil-works/pi-agent-core` | `0.79.8` | Pi Agent Core — agent orchestration primitives |
| `@earendil-works/pi-ai` | `0.79.8` | Pi AI — AI model abstractions and providers |
| `@earendil-works/pi-coding-agent` | `0.79.8` | Pi SDK — AI coding agent runtime |
...
| `typebox` | `1.2.17` | JSON Schema Type Builder |
